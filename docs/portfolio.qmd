...
```
For the first graphic I want to show how as you age the average glucos level tend to be higher and so is the same is with BMI. THen the second graphic I just want to show how much people can go above the dyanmic avg glucose level in this data set.
```{r}
#| code-fold: TRUE
interactive_plot <- vl_chart(height = 400, width = 600) |>
  vl_mark_boxplot() |>
...
I decided to use a basic stroke data set because a while back my dad had 5 strokes and he had many of the conditions mentioned in the data set from heart diesea, hypertension, he was also a former smoker and he is also diabetic and it is because he didnt take care of the diabetes the average glucose was pretty high. So, the combination of all these factors caused him to have a stroke
...
a.  
    ...
    - In the [second graphic](https://vega.github.io/vega-lite/docs/condition.html)  the stroke data set I added a slider that controls the color based on the threshold which I set it to 120 because thats when it start to gett dangerous for diabetic people. I thought that was intresting because then you can see observe who goes beyond that dangerzone threshold. 

    -   

b.  

    -   The color for the heat map I chose according to [wilke](https://clauswilke.com/dataviz/color-basics.html#color-as-a-tool-to-distinguish) and [github page](https://vega.github.io/vega/docs/schemes/)  where wikle advises in section 4.1 to use color as a tool to distinguish and then acordding to the documentation dark2 is cattegrocial scheme. 
    
    -   For the last stroke graphic, specificaly, followed [Knaflic'](https://github.com/Saurav6789/Books-/blob/master/storytelling-with-data-cole-nussbaumer-knaflic.pdf) advice from chapter 6 page 235. His advice is that visualization with out a story dont stick with the audince. By adding my father's story about his strokes I think I will appeal to the emotion of the audience and hence it will stick with them for longer.
