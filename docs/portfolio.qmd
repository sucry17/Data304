...
For the first graphic, I want to show how, as you age, the average glucose level tends to be higher, and the same is true for BMI. In the second graphic, I just want to show how much people's glucose levels can exceed the dynamic average glucose level in this dataset cotroled by a slider.
...
-   QUESTION 3: If you were tasked with communicating this data, which option would you choose and why?
    ...
    -   If I was tasked with communicating this data as is I would chose the bar graph . The reason for this is that this graph is straightforward forward showing the trend change between years and communicating the data easily and effectively.
